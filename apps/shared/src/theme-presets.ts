...
export const THEME_PRESET_PALETTES = {
  ...
  /** ALTA — brand orange primary, brand green accent (from alta-geotecnia.png). */
  alta: {
    colors: {
      background: '#ffffff',
      foreground: '#1b241d',
      ...
      primaryForeground: '#ffffff',
      secondary: '#e3f0d9',
      secondaryForeground: '#135229',
      accent: '#e9f2e2',
      accentForeground: '#135229',
      border: '#d8e2d2',
      input: '#ffffff',
      ring: '#ee7123',
      midground: '#135229',
      ...
      destructive: '#cf222e',
      destructiveForeground: '#ffffff',
      sidebarBackground: '#f5f8f3',
      sidebarBorder: '#d8e2d2',
      userBubble: '#e3f0d9',
      userBubbleBorder: '#d8e2d2'
    },
    darkColors: {
      background: '#0d1410',
      foreground: '#eef3ea',
      card: '#0a100c',
      cardForeground: '#eef3ea',
      muted: '#182219',
      mutedForeground: '#8fa08f',
      popover: '#101a13',
      popoverForeground: '#eef3ea',
      primary: '#f3893f',
      primaryForeground: '#1a1006',
      secondary: '#1c3020',
      secondaryForeground: '#dcebd6',
      accent: '#18291b',
      accentForeground: '#dcebd6',
      border: '#2b3e2d',
      input: '#101a13',
      ring: '#f3893f',
      midground: '#8ec340',
      midgroundForeground: '#12200f',
      composerRing: '#f3893f',
      destructive: '#f85149',
      destructiveForeground: '#ffffff',
      sidebarBackground: '#0a100c',
      sidebarBorder: '#2b3e2d',
      userBubble: '#16261a',
      userBubbleBorder: '#2b3e2d'
    }
  },
  slate: {
    colors: {
